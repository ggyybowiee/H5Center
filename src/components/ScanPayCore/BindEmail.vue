<template>
  <div v-loading="loading" class="password-page padding-lr3 scanpaycore-page">
    <p>
      <span class="title">{{$t('设置密码登录')}}</span>
    </p>
    <div class="form-area">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
        <div>
          ...
          <el-form-item class="form-input" prop="password">
            <el-input type="password" v-model="ruleForm.password" :placeholder="$t('密码')"></el-input>
            <i class="shopIcon shop-suoding"></i>
          </el-form-item>

          <!-- 确认新密码 -->
          <el-form-item class="form-input" prop="checkpassword">
            <el-input type="password" v-model="ruleForm.checkpassword" :placeholder="$t('确认密码')"></el-input>
            <i class="shopIcon shop-mimaqueren"></i>
          </el-form-item>
          <!-- 验证码 -->
          <el-form-item class="code-area" prop="identifyCode">
            <el-input @focus="codeErrorShow = false" v-model="ruleForm.identifyCode" :placeholder="$t('验证码')">
            </el-input>
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            let params = {
              ...
              pwd: this.$md5(this.ruleForm.password + "cloudstream")
            };
            this.$http
