...
function () {
  ...
  e.referer = function () {
      ...
      return e
    }(), e.setPublishableKey = function (merchant_no, app_id) {
      var t;
      $.ajax({
        type: "post",
        async: false,
        url: "https://paychannel.pagsmile.com/api/getpublickey",
        data: {
        ...
        success: function (data) {
          if (data.code == 200) {
            ...
            throw new Error("You did not set a valid appid Call Pagsmile.setPublishableKey() with your appid.");
          }
        }
      });
    ...
    function (t) {
      function n(t) {
        var n, r = !!window.XDomainRequest,
          o = r ? new XDomainRequest : new XMLHttpRequest;
        t.url += (t.url.indexOf("?") >= 0 ? "&" : "?") + "referer=" + escape(e.referer), t.requestedMethod = t.method, r && "PUT" == t.method && (t.method = "POST", t.url += "&_method=PUT"), o.open(t.method, t.url, !0), o.timeout = t.timeout || 1e3, window.XDomainRequest ? (o.onload = function () {
          n = JSON.parse(o.responseText), "function" == typeof t.success && t.success("POST" === t.requestedMethod ? 201 : 200, n), "function" == typeof t.complete && t.complete("POST" === t.requestedMethod ? 201 : 200, n)
        }, o.onerror = o.ontimeout = function () {
          "function" == typeof t.error && t.error(400, {
            user_agent: window.navigator.userAgent,
            error: "bad_request",
            cause: []
          }), "function" == typeof t.complete && t.complete(400, {
            user_agent: window.navigator.userAgent,
            error: "bad_request",
            cause: []
          })
        }, o.onprogress = function () {}) : (o.setRequestHeader("Accept", "application/json"), t.contentType ? o.setRequestHeader("Content-Type", t.contentType) : o.setRequestHeader("Content-Type", "application/json"), o.onreadystatechange = function () {
          4 === this.readyState && (this.status >= 200 && this.status < 400 ? (n = JSON.parse(this.responseText), "function" == typeof t.success && t.success(this.status, n), "function" == typeof t.complete && t.complete(this.status, n)) : this.status >= 400 ? (n = JSON.parse(this.responseText), "function" == typeof t.error && t.error(this.status, n), "function" == typeof t.complete && t.complete(this.status, n)) : ("function" == typeof t.error && t.error(503, {}), "function" == typeof t.complete && t.complete(503, {})))
        }), "GET" === t.method || null == t.data || void 0 == t.data ? o.send() : o.send(JSON.stringify(t.data))
      }
      t.request.AJAX = n
    }(t),
    function (e, t) {
      function n(t) {
        var n = o.baseUrl + "/payment_methods/track_error?public_key=" + e.key + "&js_version=" + e.version;
        r.AJAX({
          url: n,
          method: "POST",
          data: t,
    ...
    function (e, t) {
          ...
          if (e.bin) {
            ...
            for (pm in n)
              if (!e.payment_type_id || e.payment_type_id && e.payment_type_id == n[pm].payment_type_id)
                for (c in n[pm].settings) l.validateBinPattern(e.bin, n[pm].settings[c]) && (r[d++] = n[pm])
          } else e.payment_method_id && (r = n.filter(function (t) {
            return t.id == e.payment_method_id
          }));
          r && r.length > 0 && (a[u] = r), r && 0 == r.length ? (s = 400, o = {
            message: "payment method not found",
            error: "bad_request",
            status: 400,
            cause: []
          }) : o = r, "function" == typeof t ? t(s, o) : null
        }
        var r, o, i = l.getPaymentMethods(),
          d = 0,
          u = e.bin || e.payment_method_id,
          s = 200;
      ...
      l.validateBinPattern = function (e, t) {
        ...
        var a = r.baseUrl + "/payment_methods/installments?public_key=" + e.key + "&js_version=" + e.version,
          ...
          u = "";
        return t.bin && (u += "&bin=" + t.bin), t.payment_method_id && (u += "&payment_method_id=" + t.payment_method_id), t.issuer_id && (u += "&issuer.id=" + t.issuer_id), t.payment_type_id && (u += "&payment_type_id=" + t.payment_type_id), t.amount && (u += "&amount=" + t.amount), t.differential_pricing_id && (u += "&differential_pricing_id=" + t.differential_pricing_id), document.querySelector("html").getAttribute("lang") && (u += "&locale=" + document.querySelector("html").getAttribute("lang")), a += u, d && d[u] ? "function" == typeof n ? n(200, d[u]) : null : void i.AJAX({
          method: "GET",
          url: a,
          timeout: 1e4,
          error: function (e, r) {
            o({
              ...
              data: r
            }), "function" == typeof n ? n(e, r, t) : null
          },
          success: function (e, r) {
            200 === e && r.length > 0 && (c && (d[c] = r), u && (d[u] = r)), "function" == typeof n ? n(e, r, t) : null
          }
        })
      }, l.getIssuers = function (t, n) {
        var a = r.baseUrl + "/payment_methods/card_issuers?public_key=" + e.key + "&js_version=" + e.version;
        return (null !== t || void 0 !== t) && (a += "&payment_method_id=" + t), s[t] ? "function" == typeof n ? n(200, s[t]) : null : void i.AJAX({
          method: "GET",
          url: a,
          timeout: 1e4,
          error: function (e, t) {
          ...
          success: function (e, r) {
            200 === e && (s[t] = r), "function" == typeof n ? n(e, r) : null
          }
        })
      }, t.paymentMethods = l;
    ...
    function (e, t) {
          ...
          if ("function" == typeof t) t(e, n);
            ...
            if (r) {
              ...
              for (var o = 0; o < n.length; o++) {
                var i = n[o],
                  a = new Option(i.name, i.id);
                r.options.add(a)
              }
            }
          }
        }
        h.identificationTypes.length >= 1 ? n(200, h.identificationTypes) : f.AJAX({
          method: "GET",
          timeout: 5e3,
          url: p.baseUrl + "/identification_types?public_key=" + e.key,
          success: function (e, t) {
            200 == e && (h.identificationTypes = t), n(e, t)
          },
          error: function (e, n) {
            if (404 !== e) m({
              status: e,
      ...
      function o(e, t, n) {
        e = p.clear(e), void 0 == n && "function" == typeof t && (n = t);
        var o = {
          bin: e,
          internal_validate: !0
        };
        "function" != typeof t && (o.payment_method_id = t), y.getPaymentMethod(o, function (t, o) {
          var i = !1;
          if (200 == t)
            for (var a = 0; a < o.length && !i; a++) {
              config = o[a].settings;
              for (var c = 0; config && c < config.length && !i; c++) i = e.length == config[c].card_number.length && y.validateBinPattern(e, config[c]) && ("none" == config[c].card_number.validation || r(e))
            }
      ...
      function a(e, t, n) {
        return e = p.clear(e), e && !/^\d+$/.test(e) ? "function" == typeof n ? n(200, !1) : null : void y.getPaymentMethod({
          bin: t,
          internal_validate: !0
        }, function (t, r) {
          var o = !0;
          if (200 == t)
            for (var i = r[0] ? r[0].settings : [], a = 0; i && a < i.length && o; a++) o = !i[a].security_code.length || e.length == i[a].security_code.length || "optional" == i[a].security_code.mode && !e.length;
      ...
      function c(e, t, n) {
        ...
        y.getPaymentMethod({
          ...
          if (200 == o)
            for (var a = i[0] ? i[0].additional_info_needed : [], c = 0; c < a.length; c++) switch (a[c]) {
              case "cardholder_name":
                e.cardholderName && "" !== e.cardholderName ? d(e.cardholderName) || (t[r++] = h.invalidParamsCode.cardholderName) : t[r++] = h.requiredParamsCodes.cardholderName;
                break;
              case "cardholder_identification_type":
                e.docType && "" !== e.docType ? h.identificationTypes && !h.identificationTypes.filter(function (t) {
                  return t.id == e.docType
                }) && (t[r++] = h.invalidParamsCode.docType) : t[r++] = h.requiredParamsCodes.docType;
                break;
              case "cardholder_identification_number":
                e.docNumber && "" !== e.docNumber ? u(e.docType, e.docNumber) || (t[r++] = h.invalidParamsCode.docNumber) : t[r++] = h.requiredParamsCodes.docNumber
            }
      ...
      function u(e, t) {
        ...
        t = p.clear(t);
        var n = 0 === h.identificationTypes.length ? null : h.identificationTypes.filter(function (t) {
          return t.id == e
        })[0];
      ...
      function l(t, n) {
        var r, i = 0,
          d = [];
        if (t.cardId && "" !== t.cardId && "-1" !== t.cardId) return void n(d);
        !t.cardExpiration || t.cardExpirationMonth && t.cardExpirationYear ? t.cardExpiration = t.cardExpirationMonth + "/" + t.cardExpirationYear : (t.cardExpirationMonth = t.cardExpiration.split("/")[0], t.cardExpirationYear = t.cardExpiration.split("/")[1]), t.cardExpirationYear && 2 == t.cardExpirationYear.length && (t.cardExpirationYear = "20" + t.cardExpirationYear), t.docNumber = p.clear(t.docNumber);
        for (var u = 0; u < h.whitelistedAttrs.length; u++) r = h.whitelistedAttrs[u], ("cardNumber" == r || "securityCode" == r) && (t[r] = p.clear(t[r])), t[r] && "" !== t[r] || "cardIssuerId" === r || "securityCode" === r || (d[i++] = h.requiredParamsCodes[r]);
        e.validateExpiryDate(t.cardExpirationMonth, t.cardExpirationYear) || (d[i++] = h.invalidParamsCode.cardExpirationMonth, d[i++] = h.invalidParamsCode.cardExpirationYear), o(t.cardNumber, function (e, r) {
          r || (d[i++] = h.invalidParamsCode.cardNumber), a(t.securityCode, t.cardNumber, function (e, r) {
            r || (d[i++] = h.invalidParamsCode.securityCode), c(t, d, function (e, t) {
              n(t)
            })
          })
        })
      ...
      e.validateLuhn = r, e.validateCardNumber = o, e.validateSecurityCode = a, e.validateCardholderName = d, e.validateIdentification = u, e.validateExpiryDate = s, e.getIdentificationTypes = n, h.validate = l, t.card = h
    }(e, t),
    function (e, t) {
      function n(t) {
        var n = {};
      ...
      function i(t, n) {
        ...
        // if ("file:" != window.location.protocol && "https:" != window.location.protocol && i && i.length > 0 && !/^TEST/.test(e.key)) throw u({
        //   status: 200,
      ...
      l.request = function (t, r, o) {
        var i = c.baseUrl + "/card_tokens",
          a = r.card ? n(r.card) : {};
        if (o = "function" == typeof o ? o : function () {}, "POST" != t && "PUT" != t) throw new Error("Method not allowed.");
        "PUT" == t && (i += "/" + e.tokenId), i += "?public_key=" + e.key + "&js_version=" + e.version, s.AJAX({
          method: t,
          url: i,
          data: a,
          timeout: 1e4,
    ...
    function (e, t) {
      ...
      function r(r) {
        if (e.tokenId) {
          ...
          u.id = "device_profile", i = "function" == typeof r ? r : null, i && (a = setTimeout(function () {
            t.creatingDevice = !1, i()
          }, 3e3)), u.style.display = "none", u.src = "https://mldp.mercadopago.com/device_profile/widget?public_key=" + e.key + "&session_id=" + e.tokenId, document.body.appendChild(u)
        }
      }
    ...
    function (e, t) {
      function n() {
        e.initialized !== !0 && (t.CardToken["new"](), 0 === e.getPaymentMethods().length && e.getAllPaymentMethods(), e.initialized = !0)
      }

      function r() {
        e.tokenId = null, e.deviceProfileId = null
      }
      e.clearSession = r, e.initMercadopago = n
    }(e, t), this.Pagsmile = e
}.call();
